    ...
    Conv_inv_buf_t *inv_buf)
{
	static const Msg	sysnumarr[] = {
		...
		MSG_SYS_POLLSYS,		MSG_SYS_184,
		MSG_SYS_ACL,			MSG_SYS_186,
		...
		MSG_SYS_213,			MSG_SYS_214,
		MSG_SYS_214,			MSG_SYS_215,
		MSG_SYS_215,			MSG_SYS_216,
		MSG_SYS_216,			MSG_SYS_217,
		MSG_SYS_217,			MSG_SYS_218,
		MSG_SYS_218,			MSG_SYS_219,
		MSG_SYS_219,			MSG_SYS_220,
		MSG_SYS_220,			MSG_SYS_221,
		MSG_SYS_221,			MSG_SYS_222,
		MSG_SYS_223,			MSG_SYS_224,
...
#define	SYSSET_FLAGSZ	CONV_EXPN_FIELD_DEF_PREFIX_SIZE + \
	...
	MSG_SYS_184_SIZE			/* 184 (unused) */ + \
	MSG_SYS_ACL_ALT_SIZE			/* 185 */ + \
	MSG_SYS_186_SIZE			/* 186 (unused) */ + \
	...
	MSG_SYS_213_SIZE			/* 213 */ + \
	MSG_SYS_214_SIZE			/* 214 */ + \
	MSG_SYS_215_SIZE			/* 215 */ + \
	MSG_SYS_216_SIZE			/* 216 */ + \
	MSG_SYS_217_SIZE			/* 217 */ + \
	MSG_SYS_218_SIZE			/* 218 */ + \
	MSG_SYS_219_SIZE			/* 219 */ + \
	MSG_SYS_220_SIZE			/* 220 */ + \
	MSG_SYS_221_SIZE			/* 221 */ + \
	MSG_SYS_222_SIZE			/* 222 */ + \
	MSG_SYS_223_SIZE			/* 223 */ + \
	MSG_SYS_224_SIZE			/* 224 (unused) */ + \
	\
	/* sysset_t[7] - System Calls [225 - 256] */ \
	MSG_SYS_225_SIZE			/* 225 */ + \
...
#define	N_MASK 16
	...
	static const Val_desc vda5[] = {	/* System Calls [161 - 192] */
		...
		{ 0x00800000,	MSG_SYS_184 },
		{ 0x01000000,	MSG_SYS_ACL_ALT },
		{ 0x02000000,	MSG_SYS_186 },
	...
	static const Val_desc vda6[] = {	/* System Calls [193 - 224] */
		...
		{ 0x00100000,	MSG_SYS_213 },
		{ 0x00200000,	MSG_SYS_214 },
		{ 0x00400000,	MSG_SYS_215 },
		{ 0x00800000,	MSG_SYS_216 },
		{ 0x01000000,	MSG_SYS_217 },
		{ 0x02000000,	MSG_SYS_218 },
		{ 0x04000000,	MSG_SYS_219 },
		{ 0x08000000,	MSG_SYS_220 },
		{ 0x10000000,	MSG_SYS_221 },
		{ 0x20000000,	MSG_SYS_222 },
		{ 0x40000000,	MSG_SYS_223 },
