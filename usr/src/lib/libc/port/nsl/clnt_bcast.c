 ...
 *
 * We send two packets for UDP, one for rpcbind and one for portmap.
 * For those machines which support both rpcbind and portmap, it will
 * cause them to reply twice, and also here it will get two responses
