...
cleanup:
	freezero(salt, salt ? (strlen(salt) + 1) : 0);
	freezero(tmp_pin, tmp_pin ? (strlen((char *)tmp_pin) + 1) : 0);
...
cleanup:
	freezero(salt, salt ? (strlen(salt) + 1) : 0);
	freezero(ks_cryptpin, ks_cryptpin ? (strlen(ks_cryptpin) + 1) : 0);
	freezero(tmp_old_pin, tmp_old_pin ? (strlen((char *)tmp_old_pin) + 1) : 0);
	freezero(tmp_new_pin, tmp_new_pin ? (strlen((char *)tmp_new_pin) + 1) : 0);
