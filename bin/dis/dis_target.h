...
const char *dis_tgt_lookup(dis_tgt_t *, uint64_t, uint64_t *, int, size_t *,
    int *);
const char *dis_find_section(dis_tgt_t *, uint64_t, uint64_t *);
const char *dis_tgt_name(dis_tgt_t *);
const char *dis_tgt_member(dis_tgt_t *);
void dis_tgt_ehdr(dis_tgt_t *, GElf_Ehdr *);
uint64_t dis_tgt_next_symbol(dis_tgt_t *, uint64_t);
