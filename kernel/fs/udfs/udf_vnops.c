...
const struct vnodeops udf_vnodeops = {
	.vnop_name = "udfs",
	.vop_open = udf_open,
	.vop_close = udf_close,
	.vop_read = udf_read,
	...
	.vop_create = udf_create,
	.vop_remove = udf_remove,
	.vop_link = udf_link,
	.vop_rename = udf_rename,
	.vop_mkdir = udf_mkdir,
	.vop_rmdir = udf_rmdir,
	.vop_readdir = udf_readdir,
	.vop_symlink = udf_symlink,
	.vop_readlink = udf_readlink,
	.vop_fsync = udf_fsync,
	.vop_inactive = udf_inactive,
	.vop_fid = udf_fid,
	.vop_rwlock = udf_rwlock,
	.vop_rwunlock = udf_rwunlock,
	.vop_seek = udf_seek,
	.vop_frlock = udf_frlock,
	.vop_space = udf_space,
	.vop_getpage = udf_getpage,
	.vop_putpage = udf_putpage,
	.vop_map = udf_map,
	.vop_addmap = udf_addmap,
	.vop_delmap = udf_delmap,
	.vop_pathconf = udf_l_pathconf,
