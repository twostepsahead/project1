...
/*ARGSUSED*/
static int
hsfs_getpage_ra(struct vnode *vp, uoff_t off, struct seg *seg,
...
/*ARGSUSED*/
static int
hsfs_getapage(struct vnode *vp, uoff_t off, size_t len, uint_t *protp,
...
/*ARGSUSED*/
int
hsfs_putapage(vnode_t *vp, page_t *pp, uoff_t *offp, size_t *lenp,
    int flags, cred_t *cr)
{
