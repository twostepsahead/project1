...
static uoff_t seghole_getoffset(struct seg *, caddr_t);
...
static struct seg_ops seghole_ops = {
	...
	.free		= seghole_free,
	.fault		= seghole_fault,
	.faulta		= seghole_faulta,
	.setprot	= seghole_setprot,
	.checkprot	= seghole_checkprot,
	.sync		= seghole_sync,
	.incore		= seghole_incore,
	.lockop		= seghole_lockop,
	.getprot	= seghole_getprot,
	.getoffset	= seghole_getoffset,
	.gettype	= seghole_gettype,
	.getvp		= seghole_getvp,
	.advise		= seghole_advise,
	.pagelock	= seghole_pagelock,
	.setpagesize	= seghole_setpagesize,
};
